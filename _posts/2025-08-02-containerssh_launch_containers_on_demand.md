...
<span style="color:rgb(78, 191, 12);"><strong>[ContainerSSH](https://containerssh.io/v0.5/)</strong></span> is a modern SSH server that starts a new container for every SSH connection. Instead of granting direct access to a host system, it dynamically spins up a container when a user logs in, providing a secure, clean, and resource efficient environment.
